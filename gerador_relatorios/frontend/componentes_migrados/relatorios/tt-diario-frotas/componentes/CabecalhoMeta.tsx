...
export function CabecalhoMeta({
  ...
  return (
    <div
      className={`bg-slate-50 border border-slate-200 rounded-md text-center ${compact ? 'p-2 mb-1' : 'p-2 mb-4'} ${className}`}
    >
      ...
      {sufixoMedia && (
        <div className={`${compact ? 'text-[9px]' : 'text-[10px]'} text-slate-500 italic mt-0.5`}>
          * {sufixoMedia}
        </div>
      )}
    </div>
