...
interface ItemFaltaApontamento {
  ...
  tempoOcioso: number // horas (tempo s/ apontar)
}
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {/* Lado Esquerdo: Tempo s/ Apontar */}
                {isTight ? (
                  <div className="flex items-center justify-between w-[140px] min-w-[140px] gap-2">
                ...
                {isTight ? (
                  <div className="flex items-center justify-between w-[100px] min-w-[100px] gap-2">
