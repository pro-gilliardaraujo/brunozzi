...
export function GraficoMediaVelocidade({ dados, meta, compact = true, listrado = true }: GraficoMediaVelocidadeProps) {
  ...
  // Ordenar por velocidade crescente
  ...
  const corMedia = isMetaAtingida ? '#48BB78' : '#E53E3E'
