...
interface ItemEficienciaOperacionalTrator {
  id: string | number
  nome: string
  eficiencia: number
  horasMotor: number
...
interface GraficoEficienciaOperacionalTratorProps {
  dados: ItemEficienciaOperacionalTrator[]
  meta: number
  compact?: boolean
  listrado?: boolean
}

export function GraficoEficienciaOperacionalTrator({
  dados,
  meta,
  compact = true,
  listrado = true,
}: GraficoEficienciaOperacionalTratorProps) {
