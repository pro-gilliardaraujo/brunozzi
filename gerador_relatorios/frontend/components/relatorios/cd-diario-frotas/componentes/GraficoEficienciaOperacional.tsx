...
interface ItemEficienciaOperacional {
  id: string | number
  nome: string
  eficiencia: number
  horasMotor: number
...
interface GraficoEficienciaOperacionalProps {
  dados: ItemEficienciaOperacional[]
  meta: number
  compact?: boolean
  listrado?: boolean
}

export function GraficoEficienciaOperacional({ dados, meta, compact = true, listrado = true }: GraficoEficienciaOperacionalProps) {
