...
// Fix para ícones do Leaflet no Next.js moved to component useEffect or inside a client-side only block
...
export default function MapaColheita({ tipo, dadosExternos }: MapaColheitaProps) {
  ...
  useEffect(() => {
    ...
    // Fix para ícones do Leaflet - Executar apenas no cliente
